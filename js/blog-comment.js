...
*/
var firebaseConfig = {
    apiKey: "AIzaSyA3WKoIYCsxvT5uTtItRrOY8EPHctPK_VE",
    authDomain: "dikephilipblog-comment.firebaseapp.com",
    databaseURL: "https://dikephilipblog-comment.firebaseio.com",
    projectId: "dikephilipblog-comment",
    storageBucket: "dikephilipblog-comment.appspot.com",
    messagingSenderId: "568175499709",
    appId: "1:568175499709:web:621a8cb930c197341e5ad4",
    measurementId: "G-XLXHKF5XWB"
    };
  ...
  ( () => {
    ...
    class Display extends Globals {
      ...
      createMarkup(s, t) {
        ...
        let html = `<div class="${type}-item comment-body comment-meta">
          <div class="left comment-author"><img class="author-grav img-fluid" src="https://www.gravatar.com/avatar/${s.md5Email}?s=80&d=retro"></div>
          <h4>${xssFilters.inHTMLData(s.name)}</h4>
          <small class = 'comment-metadata'>${timeago().format(s.postedAt)}</small>
          <p class='comment-content'>${xssFilters.inHTMLComment(s.message)}</p>
